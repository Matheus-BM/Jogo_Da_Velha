...
public class Jogo_Da_Velha_Comentado {
	...
	private static String modoJogo() {	
		...
		while(true) {	
			System.out.println("Escolha um modo de jogo (1 ou 2) \n"
					+ "1. Jogador x Jogador \n"
					+ "2. Jogador x CPU");
			...
			switch (Main.scan()) {
				...
				case "2":
					return "JogadorXCPU";
				default:
					System.out.println("Numero fora Permitido! Tente Novamente.\n");
			}
		}
	...
	private static void jogadaJogador(String[][] tabuleiro,String jogadorAtual,String modoJogo) {
		System.out.println("Jogador "+jogadorAtual+ " Escolha uma casa (1 a 9)\n");
